...
int main(void)
{
	...
	while (1)
	{
		...
		if (HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_2) == 0 && (currentMillis - previousMillis > 150))
		{
			data = 1;
			sendData();
			data = 0;
		...
		if (HAL_GPIO_ReadPin(GPIOC, GPIO_PIN_3) == 0 && (currentMillis - previousMillis > 150))
		{
			data = 2;
			sendData();
			data = 0;
		...
		if (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_14) == 0 && (currentMillis - previousMillis > 150))
		{
			data = 3;
			sendData();
			data = 0;
		...
		if (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_15) == 0 && (currentMillis - previousMillis > 150))
		{
			data = 4;
			sendData();
			data = 0;
